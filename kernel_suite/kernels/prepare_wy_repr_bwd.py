...
from fla.ops.gated_delta_rule.wy_fast import prepare_wy_repr_bwd as source_fn
...
def launch(inputs):
    return source_fn(k=inputs["k"], v=inputs["v"], beta=inputs["beta"], A=inputs["A"], dw=inputs["dw"], du=inputs["du"], g=inputs["g"], cu_seqlens=inputs["cu_seqlens"])
